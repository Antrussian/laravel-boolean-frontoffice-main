...
import ProjectCard from './AppProjectCard.vue'; // Assicurati che il percorso sia corretto
...
/* Assicurati di avere questo stile dentro al tag <style> del tuo componente ProjectCard, non qui in AppMain, se vuoi che queste regole si applichino alle cards. */
</style>
